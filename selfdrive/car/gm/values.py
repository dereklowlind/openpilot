...
CAR_INFO: Dict[str, Union[GMCarInfo, List[GMCarInfo]]] = {
  ...
  CAR.BOLT_EUV: [
    ...
    GMCarInfo("Chevrolet Bolt EV 2022-23", "LT Trim"),
  ],
  CAR.SILVERADO: [
...
FINGERPRINTS = {
  ...
  # }],
  CAR.BOLT_EUV: { (Ecu.engine, 0x7E0, None): [
      b'\r12718971\x00\x00\x00\x00\x00\x00\x00\x0012712962\x00\x00\x00\x00\x00\x00\x00\x0012712958\x00\x00\x00',
      b'\x00\x00\x00\x00\x0042687139\x00\x00\x00\x00\x00\x00\x00\x0042705739\x00\x00\x00\x00\x00\x00\x00\x009281031',
      b'01A\x00\x00\x00\x00\x00\x0013536793\x00\x00\x00\x00\x00\x00\x00\x0013526562\x00\x00\x00\x00\x00\x00\x00',
      b'\x0013530651\x00\x00\x00\x00\x00\x00\x00\x0013536797\x00\x00\x00\x00\x00\x00\x00\x0012712965\x00\x00\x00',
      b'\x00\x00\x00\x00\x0012712973\x00\x00\x00\x00\x00\x00\x00\x0012712966\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
  },
  CAR.SILVERADO: [
  {
